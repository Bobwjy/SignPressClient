    ...
    */
    ...
    public class MyOpaqueLayer : System.Windows.Forms.Control
    {
        ...
        public MyOpaqueLayer()
            : this(125, true ,true,"正在加载")
        {
        }

        public MyOpaqueLayer(int Alpha, bool IsShowLoadingImage, bool IsShowLabel, string Msg)
        {
            ...
            if (IsShowLoadingImage)
            {
                ...
                pictureBox_Loading.Image = SignPressClient.Properties.Resources.loading;
            ...
            if (IsShowLabel)
            {
                Label l = new Label();
                l.Text = Msg;
                l.Font = new System.Drawing.Font("微软雅黑", 11.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
                Point Location = new Point(this.Location.X + (this.Width / 2 + pictureBox_Loading.Width / 2), this.Location.Y + (this.Height - pictureBox_Loading.Height) / 2 + 15);
                l.Location = Location;
